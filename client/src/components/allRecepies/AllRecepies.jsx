        ...
        <div className="recepiesContainer">
            ...
            <section>
                ...
                <div className="additionals">
                    <h5>Cooking time: 103m</h5>
                    <h5>Likes: 5</h5>
                    <button>Like</button>
                </div>
            </section>
            <section>
                <img src="https://www.az-jenata.bg/media/files/resized/article/654x/d4f/b49e382a5a48473579279273cc988d4f-a5676490ac6968d311d53e0a2eb9ebea.jpg" alt="" />
                <h2>Rise</h2>
                <div className="additionals">
                    <h5>Cooking time: 103м</h5>
                    <h5>Likes: 5</h5>
                    <button>Like</button>
                </div>
            </section>
            <section>
                <img src="https://ezine.bg/files/1200x800/rodopski-patatnik-bez-kori-flx.webp" alt="" />
                <h2>Pancakes</h2>
                <div className="additionals">
                    <h5>Cooking time: 190м</h5>
                    <h5>Likes: 123</h5>
                    <button>Like</button>
                </div>
            </section>
